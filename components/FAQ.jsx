        ...
        <div className="max-w-screen-md mx-auto">
          ...
          <Accordion type="single" collapsible className="space-y-2">
            {faqs.map((faq, index) => (
              ...
              >
                <AccordionTrigger
                  className="p-4 text-lg font-medium flex justify-between items-center hover:bg-gray-50 transition"
                  style={{
                    borderBottom: index === 1 ? '1px solid #E5E7EB' : undefined, // Light gray separator
                  }}
                >
                  {faq.question}
                </AccordionTrigger>
                <AccordionContent className="p-4 text-left text-gray-600 bg-purple-50 rounded-b-lg">
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
  ...
  const faqs = [
    {
      ...
      answer: "Unfold is expected to launch in the upcoming months. Stay tuned for updates!",
    },
    {
